...
namespace PayrollApp.Test
{
    public class ManagerPayTest
    {
        ...
        public void GetExperienceTest(string chosenDate, int exp)
        {
            ...
            Worker worker = PayTest.workers[1];
            ManagerPay ManagP = new ManagerPay();
            PayViewModel.SetInstance(worker, ManagP);
            

            int result = ManagP.GetExperience(date);
            int expected = exp;
        ...
        [TestCase("12.12.2031", 56130)]
        [TestCase("12.12.2041", 56130)]
        [TestCase("12.12.2026", 50115)]
        public void GetSalaryTest(string chosenDate, decimal summ)
        {
            ...
            var result = ManagP.GetSalary(date);
