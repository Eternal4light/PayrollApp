...
{
    //Это решение я позаимствовал в коде одного немца в открытом источнике
    ...
    public class TextBoxInputBehavior : Behavior<TextBox>
    {
        ...
        public static readonly DependencyProperty JustPositivDecimalInputProperty =
            DependencyProperty.Register(
                "JustPositivDecimalInput", typeof(bool),
        ...
        private bool IsValidInput(string input)
        {
            switch (InputMode)
            {
                ...
                case TextBoxInputMode.NoCirillic:
                    return CheckIsNotCirillic(input);
        ...
        private bool CheckIsDecimal(string input)
        {
            ...
            var result = decimal.TryParse(input, validNumberStyles, CultureInfo.CurrentCulture, out decimal d);
            return result;
        }

        private bool CheckIsNotCirillic(string input)
        {
